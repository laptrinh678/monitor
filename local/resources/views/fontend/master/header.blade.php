<header class="header">
        <a href="{{url('')}}" class="logo">
            <img src="{{url('public/fontend/img')}}/logo.png" alt="Logo">
        </a>
            ...
            <div class="navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{url('public/fontend')}}/img/authors/avatar3.jpg" width="35" class="img-circle img-responsive pull-left" height="35" alt="riot">
                            <div class="riot">
                                <div>
                                    Riot
                                    <span>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header bg-light-blue">
                                <img src="{{url('public/fontend')}}/img/authors/avatar3.jpg" width="90" class="img-circle img-responsive" height="90" alt="User Image" />
