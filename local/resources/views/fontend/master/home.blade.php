            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <div class="layout-image">
                        <img src="{{url('public/fontend')}}/images/layout.png" class="img-responsive" />
                    </div>
                </div>
    ...
    <div class="container">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_default_1">
                                <div class="media">
                                    <div class="media-left tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="{{url('public/fontend')}}/images/authors/img1.jpg" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
                            ...
                            <div class="tab-pane" id="tab_default_2">
                                <div class="media">
                                    <div class="media-left media-middle tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="{{url('public/fontend')}}/images/authors/img2.jpg" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
                            ...
                            <div class="tab-pane" id="tab_default_3">
                                <div class="media">
                                    <div class="media-left media-middle tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="{{url('public/fontend')}}/images/authors/img3.jpg" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
                            ...
                            <div class="tab-pane" id="tab_default_4">
                                <div class="media">
                                    <div class="media-left media-middle tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="{{url('public/fontend')}}/images/authors/img4.jpg" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-5 profile">
                <div class="thumbnail bg-white">
                    <img src="{{url('public/fontend')}}/images/img_3.jpg" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <b>John Doe</b>
                        <br /> Founder & Partner
                        <br />
            ...
            <div class="col-md-3 col-sm-5 profile">
                <div class="thumbnail bg-white">
                    <img src="{{url('public/fontend')}}/images/img_5.jpg" alt="team-image">
                    <div class="caption">
                        <b>John Doe</b>
                        <br /> Founder & Partner
                        <br />
            ...
            <div class="col-md-3 col-sm-5 profile">
                <div class="thumbnail bg-white">
                    <img src="{{url('public/fontend')}}/images/img_4.jpg" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <b>John Doe</b>
                        <br /> Founder & Partner
                        <br />
            ...
            <div class="col-md-3 col-sm-5 profile">
                <div class="thumbnail bg-white">
                    <img src="{{url('public/fontend')}}/images/img_6.jpg" alt="team-image">
                    <div class="caption">
                        <b>John Doe</b>
                        <br /> Founder & Partner
                        <br />
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <img src="{{url('public/fontend')}}/images/image_12.jpg" class="img-responsive">
                <p>
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <img src="{{url('public/fontend')}}/images/image_11.jpg" class="img-responsive">
                <p>
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                </p>
                <p>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="author">
                    <img src="{{url('public/fontend')}}/images/authors/avatar3.jpg" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
            ...
            <div class="col-md-4">
                <div class="author">
                    <img src="{{url('public/fontend')}}/images/authors/avatar2.jpg" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
                        <small class="text-right">Themeforest.net</small>
            ...
            <div class="col-md-4">
                <div class="author">
                    <img src="{{url('public/fontend')}}/images/authors/avatar4.jpg" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
                        <small class="text-right">Themeforest.net</small>
