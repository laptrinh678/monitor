...
@section('title')
<title>Thêm mới nguyên nhân</title>
@endsection('title')
@section('content')
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i>Tạo mới nguyên nhân
                                </h3>
                ...
                <label for="first_name" class="col-sm-2 control-label">Reason Group</label>
                    <div class="col-sm-6">
                        ...
                        <select class="form-control" name="parentId">
						    <option value="0">Chọn Group nguyên nhân</option>
